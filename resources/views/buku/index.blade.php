                                    ...
                                    <tbody>
                                        @forelse ($buku as $key => $values)
                                            <tr>
                                                ...
                                                <td>{{ $values->stok }}</td>
                                                <td>{{ $values->rak[0]->nama_rak }}</td>
                                                <td>
                                                    <a href="{{ route('buku.show', $values->id) }}"
                                                        class="btn-sm btn-info">Show</a>
                                                    <a href="{{ route('buku.edit', $values->id) }}"
                                                        ...
                                                        <div class="modal-dialog">
                                                            <div class="modal-content">
                                                                ...
                                                                <div class="modal-body">
                                                                    Delete <strong>{{ $values->judul_buku }}</strong>?
                                                                </div>
                                                                <div class="modal-footer">
                                                                    <form action="{{ route('buku.destroy', $values->id) }}"
